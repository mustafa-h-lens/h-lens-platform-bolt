# Migration: Complete Activity Logging Coverage

Run this SQL in Supabase SQL Editor (Dashboard > SQL Editor > New Query).

This adds 13 database triggers to log ALL admin actions that were previously missing from the activity log.

## What it covers

| # | Table | Actions Logged |
|---|-------|---------------|
| 1 | projects | create, update, delete, status change |
| 2 | project_items | add, update, delete |
| 3 | project_files | upload, delete |
| 4 | invoices | create, update, delete, status change, payment |
| 5 | vendor_financial_data | add, update, delete |
| 6 | vendor_travel_documents | add, update, delete |
| 7 | vendor_suggestions | submit, status change, update, delete |
| 8 | service_items | create, update, deactivate, delete |
| 9 | task_po_allocations | create, update, delete |
| 10 | equipment_brands | create, update, delete |
| 11 | equipment_categories | create, update, delete |
| 12 | po_settings | create, update |
| 13 | terms_and_privacy_settings | create, update |
