/*
  ...
  1. Changes
    ...
    - Convert 'client_user' role to 'client'
    - Update CHECK constraint to only allow: super_admin, project_manager, client
    - Update is_admin() function to recognize project_manager
    - Update all RLS policies that reference 'admin' role

  2. Final Roles
    - `super_admin` - Full access to everything
    - `project_manager` - Can manage projects, vendors, clients (no Settings/User Management/Activity Log)
    - `client` - Can view their own projects only
