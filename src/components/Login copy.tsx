  ...
  return (
    <>
      <style>{`
        ...
        .hl-logo img { height: 36px; width: auto; object-fit: contain; }
        ...
        .hl-mobile-logo img { height: 36px; object-fit: contain; }
      ...
      <div className="hl-login">
        ...
        <div className="hl-left">
          ...
          <div className="hl-right-z hl-logo">
            <img src="/half_lens_logo_-_color.png" alt="Half Lens" />
          </div>
