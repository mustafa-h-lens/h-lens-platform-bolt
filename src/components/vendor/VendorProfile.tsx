...
export function VendorProfile() {
  ...
  const [infoForm, setInfoForm] = useState({
    ...
    phone: vendor?.phone?.replace(/^\+\d+/, '') || '', // إزالة رمز الدولة من رقم الهاتف
    email: vendor?.email || '',
  ...
  const saveInfo = async () => {
    ...
    try {
      const payload: Record<string, any> = {
        ...
        phone: `${infoForm.country_code}${infoForm.phone}`, // دمج رمز الدولة مع رقم الهاتف
        ...
        country_code: infoForm.country_code,
        portfolio_url: infoForm.portfolio_url || null,
        ...
        <PageCard>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 13 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
              <div>
                ...
                <div style={{ display: 'flex', gap: 0, direction: 'ltr' }}>
                  {/* Country code selector on LEFT in LTR */}
                  <SearchableSelect
            ...
            <div>
              ...
              <TextInput
                value={infoForm.portfolio_url}
                onChange={(e: any) => setInfoForm(f => ({ ...f, portfolio_url: e.target.value }))}
