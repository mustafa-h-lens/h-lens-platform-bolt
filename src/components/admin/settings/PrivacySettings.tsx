...
import { Shield, Plus, Trash2, Save, ExternalLink, History, CheckCircle, AlertTriangle } from 'lucide-react';
...
export const PrivacySettings = () => {
    ...
    try {
      ...
      if (data) {
        try {
          ...
          setContent(parsed as PrivacyContent);
        } catch {
          setContent({
  ...
  async function handleSave() {
    ...
    try {
      ...
      const updatedContent: PrivacyContent = {
        ...content,
        lastUpdated: toEnglishNumbers(new Date().toLocaleDateString('ar-EG', {
          year: 'numeric',
          month: 'long',
