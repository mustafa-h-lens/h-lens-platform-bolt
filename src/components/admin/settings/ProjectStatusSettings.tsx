      ...
      <form onSubmit={handleSubmit} className="bg-slate-50 dark:bg-slate-800 rounded-xl p-6 space-y-4">
        ...
        <div className="flex items-center gap-3">
          <button
            type="submit"
            disabled={saving}
            className={`px-6 py-2.5 text-white rounded-lg transition-all font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed ${successAnimation ? 'animate-success-flash' : ''}`}
